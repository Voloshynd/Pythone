...
while program_is_working:
    ...
    if operation in available_operations and operation == "saldo":
        while True:
    ...
    if operation in available_operations and operation == "zakup":
        while True:
    ...
    if operation in available_operations and operation == "sprzedaż":
        item_to_buy = input(
    ...
    if operation in available_operations and operation == "konto":
        print(f"Stan konta wynosi: {account} zł")

    # MAGAZYN

    if operation in available_operations and operation == "magazyn":
    ...
    if operation in available_operations and operation == "przegląd":
    ...
    if operation in available_operations and operation == "lista":
    ...
    if operation in available_operations and operation == "koniec":
